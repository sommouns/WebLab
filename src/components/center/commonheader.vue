...
<div class="center_header">
  <div class="mask1">
    <div class="head fl">
      <img src="https://s1.ax1x.com/2018/12/01/FnYZz6.jpg" alt="">
    </div>
    ...
    <div class="fr other" v-if="!Usertype">
      <ul>
        ...
        <li class="fl">关注课程<br>0门</li>
      </ul>
    </div>
    <div class="fr other" v-else>
      <ul>
        <li class="fl">好评率<br>98%</li>
        <li class="fl">学生<br>112人</li>
...
.center_header {
    ...
    .mask1 {
        ...
        .head {
            ...
            margin-left: 10rem;
            border: 3px solid rgba(222,222,222,.7);
            img {
                height: 11rem;
            }
        }
